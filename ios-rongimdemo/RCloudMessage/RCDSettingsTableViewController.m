...
#define DEFAULTS [NSUserDefaults standardUserDefaults]
    ...
    [messageChannel setMethodCallHandler:^(FlutterMethodCall * _Nonnull call, FlutterResult  _Nonnull result) {
         ...
         [appDelegate loginSuccessFlutter:call.arguments[@"nickname"] userId:call.arguments[@"id"] token:call.arguments[@"token"] password:call.arguments[@"password"] deviceid:call.arguments[@"deviceid"]];
    }];
    
    UINavigationController *navi = [[UINavigationController alloc] initWithRootViewController:flb];
