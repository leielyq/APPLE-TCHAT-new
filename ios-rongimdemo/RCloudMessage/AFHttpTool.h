...
// get user info
+ (void)getUserInfoV1:(NSString *)userId success:(void (^)(id response))success failure:(void (^)(NSError *err))failure;

//获取群组列表
+ (void)getMyGroupsSuccessV1:(void(^)(id response))success failure:(void (^)(NSError *err))failure;
