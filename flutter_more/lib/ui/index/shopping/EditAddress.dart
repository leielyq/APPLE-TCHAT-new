...
class MyHomePageedit extends StatefulWidget {
  MyHomePageedit({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _MyHomePageStateEdit createState() => _MyHomePageStateEdit();
}

class _MyHomePageStateEdit extends State<MyHomePageedit> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(centerTitle: true,
          ...
          title: Text('编辑收货地址',style: TextStyle(color: Colors.black87),),
              ...
              children: <Widget>[
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Container(
                              child: Text('地址标签',style: TextStyle(fontSize: 18),),
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Container(child: Text('设为默认地址',style: TextStyle(fontSize: 18),),),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        child:Text('删除收货地址',style: TextStyle(color: Colors.red,fontSize: 18),),
