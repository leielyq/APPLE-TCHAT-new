...
import 'package:flutter_module_tchat/ui/comment/CommentPage.dart';
import 'package:flutter_module_tchat/view/CLFlow.dart';
import 'package:extended_image/extended_image.dart';
import 'package:flutter_module_tchat/view/CustomBottomSheet.dart';
import 'package:flutter_module_tchat/view/FoldText.dart';
            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(
                      widget.item['nickname'] + " " + widget.index.toString(),
...
//    imageUrl = "https://outin-96d60c0061ac11e9b08200163e00b174.oss-cn-shanghai.aliyuncs.com/image/default/E0E5FD87961345FFB50C9A32ADD26444-6-2.jpeg?Expires=1566364611";
      images.add(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          GridView.count(
            ...
            children: getImageContaniner(widget.item['img']),
          ),
          SizedBox(
            height: 4,
          ),
